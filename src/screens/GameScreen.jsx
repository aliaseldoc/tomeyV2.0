  ...
  return (
    <main className="mx-auto flex w-full max-w-7xl flex-grow flex-col gap-lg px-container-margin pb-[100px] pt-[80px] md:flex-row">
      <section className="relative z-10 mx-auto flex w-full max-w-[800px] flex-grow flex-col justify-center">
        <ScoreLevelBar score={state.score} levelIndex={state.levelIndex} totalLevels={totalLevels} />
        <LifelinesBar
          ...
          onSkip={useSkip}
        />
        <QuestionCard category={state.activeQuestion.category} question={state.activeQuestion.question} />
        <AnswersGrid
        ...
        />
        <ProgressBar levelIndex={state.levelIndex} totalLevels={totalLevels} />
      </section>

      <ProgressLadder levelIndex={state.levelIndex} levels={state.levels} />
